...
class GAN():
    def __init__(self):
        ...
        self.input_dim = data.get_shape_input()
    ...
    def build_generator(self):
        ...
        generator.add(Dense(512, input_dim=self.latent_dim))
        generator.add(LeakyReLU(alpha=0.2))
        generator.add(BatchNormalization(momentum=0.8))
        generator.add(Dense(1024, input_dim=self.latent_dim))
        generator.add(LeakyReLU(alpha=0.2))
        generator.add(BatchNormalization(momentum=0.8))
        generator.add(Dense(self.input_dim))
        generator.add(LeakyReLU(alpha=0.2))
        generator.add(BatchNormalization(momentum=0.8))
        generator.add(Dense(self.input_dim,activation='tanh'))
    ...
    def build_discriminator(self):
        ...
        discriminator.add(Dense(1024, input_dim=self.input_dim))
    ...
    def test_auc(self, discriminator, x_test,y_test):
        ...
        roc_score_auc = roc_auc_score(y_test, score)
        print("roc_auc_score : ", roc_score_auc)
